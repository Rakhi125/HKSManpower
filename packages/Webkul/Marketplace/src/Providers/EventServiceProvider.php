...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        if (core()->getConfigData('marketplace.settings.general.status')) {
            ...
            if(core()->getConfigData('marketplace.products-setting.marketplace-product-type.grouped_active_option')){
            ...
            if(core()->getConfigData('marketplace.products-setting.marketplace-product-type.bundle_active_option')){
                ...
                // Event::listen( [ 'shop.marketplace.sellers.account.catalog.products.assign.after', 'shop.marketplace.sellers.account.catalog.product.edit-assign.after' ],
                //     function ($viewRenderEventManager) {
                //         $viewRenderEventManager->addTemplate('marketplace::shop.sellers.account.catalog.products.accordians.edit_assign_bundle_product');
                //     }
                // );
            ...
            if(core()->getConfigData('marketplace.products-setting.marketplace-product-type.booking_active_option')){
            }

    ...
    <div class="account-layout right m10">
        ...
        <form method="POST" action="" enctype="multipart/form-data" @submit.prevent="onSubmit" class="account-table-content">
            ...
            <div class="account-table-content">
                ...
                {!! view_render_event('marketplace.sellers.account.catalog.product.edit_form_accordian.booking_product', ['bookingProduct' => $product]) !!}
                    
                {!! view_render_event('marketplace.sellers.account.catalog.product.edit_form_accordian.product_group.before', ['product' => $product]) !!}

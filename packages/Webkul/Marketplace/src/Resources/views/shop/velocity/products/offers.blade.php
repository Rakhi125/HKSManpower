                                                ...
                                                @else
                                                    @if ($sellerProduct->product->isSaleable())
                                                        @if($sellerProduct->product->type == "booking")
                                                           @php 
                                                                $bookingProductPackageStatus = (int) (core()->getConfigData('marketplace.products-setting.marketplace-product-type.booking_active_option') ?? 0)
                                                            @endphp
                                                            @if($bookingProductPackageStatus == 1)
                                                                <button type="submit" class="theme-btn" style="margin-left: 20px;">
                                                                    {{ __('marketplace::app.shop.products.add-to-cart') }}
                                                                </button>
                                                            @endif
                                                        @elseif($sellerProduct->product->type == "bundle")
                                                            @php 
                                                                $bundleProductPackageStatus = (int) (core()->getConfigData('marketplace.products-setting.marketplace-product-type.bundle_active_option') ?? 0)
                                                            @endphp
                                                            @if($bundleProductPackageStatus == 1)
                                                                <button type="submit" class="theme-btn" style="margin-left: 20px;">
                                                                    {{ __('marketplace::app.shop.products.add-to-cart') }}
                                                                </button>
                                                            @endif
                                                        @elseif($sellerProduct->product->type == "grouped")
                                                            @php 
                                                                $groupedProductPackageStatus = (int) (core()->getConfigData('marketplace.products-setting.marketplace-product-type.grouped_active_option') ?? 0);
                                                            @endphp
                                                                @if($groupedProductPackageStatus == 1)
                                                                    <button type="submit" class="theme-btn" style="margin-left: 20px;">
                                                                        {{ __('marketplace::app.shop.products.add-to-cart') }}
                                                                    </button>
                                                                @endif

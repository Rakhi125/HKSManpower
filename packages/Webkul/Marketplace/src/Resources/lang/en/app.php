...
return [
    'shop' => [
        ...
        'marketplace' => [
            'already_selling' => 'This product is already selling.',
            'this_product_is_not_in_our_db' => 'This product is not available in our database.',
            'product_not_allowed' => ':producttype product is not allowed to sell.',
        ...
        'sellers' => [
            'account' => [
                'signup' => [
                    ...
                    'become-seller' => 'Become Seller',
                    'signup-page-title' => 'Create New Seller Account',
                    'seller-registration' => 'Seller Registration',
                    'wanna-be-seller' => 'Wanna Be A Seller?',
                    'as-customer' => 'Signup as Customer',
                ],
                ...
                'profile' => [
                    'allow_product_type' => 'Allowed Product Type',
                ...
                'catalog' => [
                    'products' => [
                        ...
                        'qty' => 'Quantity',
                        'selelr_price' => 'Sell Price',
                        'sort_order' => 'Sort Order',
                        'bundle_product' => 'Bundle Item',
            ...
            'mails' => [
                ...
                'report-product' => [
                    'subject' => 'Product Reported',
                    'dear' => 'Dear :name',
                    'info' => 'Your Product :product_name has been reported as :reason by :name',
                    'thanks' => 'Thanks'
                ],
                'report-product-toadmin' => [
                    'subject' => 'Seller Product Reported',
                    'dear' => 'Dear :name',
                    'info' => 'Seller Product :product_name has been reported as :reason by :name',
                    'thanks' => 'Thanks'
                ]
            ],
        ],
    ...
    'admin' => [
        ...
        'system' => [
            ...
            'yes' => 'Yes',
            'no' => 'No',
            'landing-page' => 'Default Content',
            'page-title' => 'Page Title',
            'show-banner' => 'Show Banner',
            'layout' => 'Page Layout',
            'layout1' => 'Velocity Content (Layout One)',
            'layout2' => 'Layout Two',
            ...
            'products-setting' => 'Manage Product Creation',
            'marketplace-product-type' => 'Marketplace Product Type',
            'allow_marketplace_booking_product' => 'Allow Marketplace Booking Product',
            'allow_marketplace_bundle_product' => 'Allow Marketplace Bundle Product',
            'allow_marketplace_grouped_product' => 'Allow Marketplace Grouped Product',
            'velocity-theme' => 'Select Velocity Theme',
        ],
        ...
        'sellers' => [
            ...
            'category' => [
                ...
                'save-error'        => 'Please select atleast one category',
            ]
    ...
    'mail' => [
        'seller' => [
            ...
            'update' => [
                'subject' => 'Seller Update Notification',
                'dear' => 'Dear :name',
                'info' => 'This is to inform you that your details has been updated as seller. Click below button to login.',
                'login' => 'Login',
            ],
            ...
            'good-bye' => [
                'subject' => 'Seller Delete Notification',
                'dear' => 'Dear :name',
                'info' => 'Thanks for registering as seller, your account has been now deleted successfully.'
            ],
        ...
        'sales' => [
            ...
            'paymentRequest' => [
                ...
                'dear' => 'Hello :name',
                'heading' => 'Payment Request Notification',
                'request' => 'A seller :seller_name has requested payment for his order. Order details are below',
                'requestdone' => 'Your payment Request for order has been completed. Order details are below'
    ...
    'velocity' => [
        'system' => [
            'velocity-content' => 'Velocity Content (Layout One)'
        ]
    ]
];

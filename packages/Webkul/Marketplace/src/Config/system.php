...
return [
    [
        ...
        'key' => 'marketplace.products-setting',
        'name' => 'marketplace::app.admin.system.products-setting',
        'sort' => 2,
    ], [
        'key' => 'marketplace.products-setting.marketplace-product-type',
        'name' => 'marketplace::app.admin.system.marketplace-product-type',
        'sort' => 1,
        'icon-class' => 'temp-icon',
        'fields' => \Webkul\Marketplace\Helpers\MarketPlaceProductType::returnMarketPlaceProductTypes(),
    ],
];